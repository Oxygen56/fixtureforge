...
- [x] README covers problem, solution, setup, demo, and architecture
- [x] Real DataHub OSS and official MCP judge workflow passes
- [x] Tests, negative control, determinism, and benchmark are recorded
