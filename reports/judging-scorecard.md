...
|---|---|---|
| Technological implementation | Real OSS, official MCP, compiler, four output types, independent validation, deterministic replay, writeback | Show the live chain clearly in video |
...
| Adherence to rules | New Apache-2.0 project, official MCP, English materials, disclosures | Public repo, public sub-three-minute video, test URL, Devpost submission |
| Open-source bonus | License, contribution guide, security policy, tests, CI | Publish repository and confirm license detection |
